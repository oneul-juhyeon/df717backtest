            ...
            <thead>
              <tr className="border-b border-white/10 bg-card/50">
                ...
                <th className="text-center py-4 px-4 font-medium">
                  ...
                  <span className="text-muted-foreground">DFcovenant (XAUUSD)</span>
                </th>
                <th className="text-center py-4 px-4 font-medium">
                  <span className="text-warning">● </span>
                  <span className="text-muted-foreground">DFtrust (XAUUSD)</span>
                </th>
                <th className="text-center py-4 px-4 font-medium">
                  <span className="text-success">● </span>
                  <span className="text-muted-foreground">DFpath (XAUUSD)</span>
                </th>
              </tr>
            </thead>
            <tbody>
